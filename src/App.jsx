...
const cards = [
  ...
  { icon: <RxHamburgerMenu />, title: "HAMBURGER" },
];
...
<div className="md:w-1/2">
  ...
  <p className="ml-5 mt-3 text-gray md:ml-10 xl:text-xl">Zoom helps consolidate communications, <br /> connect people, 
    and collaborate better together <br /> in the boardroom, classroom, operating room, <br /> and everywhere in between.</p>
